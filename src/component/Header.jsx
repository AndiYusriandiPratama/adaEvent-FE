...
const Header = () => {
  return (
    <>
      <nav className="bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100 w-full flex relative justify-between items-center mx-auto px-8 h-20 mb-5">
        {/* logo */}
        <div className="inline-flex">
          <a className="_o6689fn" href="/">
            <div className="flex items-center ml-10">
              <img src={logo} alt="" className="h-14 w-14 rounded-full mr-2" />
            </div>
          </a>
        </div>
        {/* end logo */}
